...
1. DESCRIPTION
-------------------------------------------------------------------------------
3dparty libraries with build scripts. Initial steps for the Linux only targets
and related build issues.
...
>
mkdir -p ~/arc/apps/dev/cmake
cd ~/arc/apps/dev/cmake
...
>
mkdir -p ~/apps/dev/cmake
sudo mv ~/arc/apps/dev/cmake/cmake-3.14.0-Linux-x86_64 ~/apps/dev/cmake

>
echo "export PATH=\$PATH:/home/tester/apps/dev/cmake/cmake-3.14.0-Linux-x86_64/bin" >> ~/.bash_profile
...
`bash_entry` module from `tacklelib` library into the `/bin` directory of your
platform:
